...
namespace WackyUndergrowth
{
    [BepInPlugin(ModGUID, ModName, ModVersion)]
    public class WackyUndergrowthPlugin : BaseUnityPlugin
    {
        internal const string ModName = "WackyUndergrowth";
    ...
    public static class PlantHaveRoofPatch
    {
        [HarmonyPrefix]
